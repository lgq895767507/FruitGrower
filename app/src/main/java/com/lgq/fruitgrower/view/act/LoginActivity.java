...
import com.lgq.fruitgrower.MainActivity;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            consumer.setPhone(email);
            consumer.setPassword(password);
            consumer.signUp(this, new SaveListener() {
                @Override
                ...
                public void onFailure(int i, String s) {
                    Toast.makeText(getApplicationContext(),"sign failed"+s,Toast.LENGTH_SHORT).show();
                }
            });
